...
public class AlarmAdapter extends RealmRecyclerViewAdapter<AlarmModel, AlarmAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CustomNotificationDialog notiDialog = CustomNotificationDialog.newInstance(obj, position);
                ...
                notiDialog.setOnChangeDataListener(new CustomNotificationDialog.OnChangeDataListener() {
                    @Override
